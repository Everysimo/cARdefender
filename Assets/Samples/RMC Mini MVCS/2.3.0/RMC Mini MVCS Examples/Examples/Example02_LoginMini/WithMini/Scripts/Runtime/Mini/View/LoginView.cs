...
namespace RMC.Core.Architectures.Mini.Samples.Login.WithMini.Mini.View
{
    ...
    public class LoginView: MonoBehaviour, IView
    {
        ...
        [HideInInspector] 
        public readonly ClearUnityEvent OnClear = new ClearUnityEvent();
        ...
        public void Initialize(IContext context)
        {
            if (!IsInitialized)
            {
                ...
                _clearButton?.onClick.AddListener(ClearButton_OnClicked);
        ...
        private void AnyInputField_OnValueChanged(string _)
        {
            ...
            _clearButton.interactable = hasValidInput;
        ...
        private void OnClearCommand(ClearCommand clearCommand)
        {
            ...
            if (_titleText != null) _titleText.text = "Login cleared";
            if (_statusText != null) _statusText.text = "(Hint: 'pass1234') ...";
